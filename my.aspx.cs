...

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["my"] == "1")
        {
            SqlCommand cmd = new SqlCommand("select *from mysroom1 where subcity=@a and min=@b and max=@c and type=@d", con);
       ...
       else if (Session["my"] == "2")
        {
            SqlCommand cmd1 = new SqlCommand("select *from myspg where subcity=@a and min=@b and max=@c and type=@d", con);
        ...
        else if (Session["my"] == "3")
        {
            SqlCommand cmd2 = new SqlCommand("select *from myshost where subcity=@a and min=@b and max=@c and type=@d", con);
