<%@ Page Language="C#" AutoEventWireup="true" CodeFile="serch.aspx.cs" Inherits="serch" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" 
            ...
            style="top: 3px; left: 264px; position: absolute; height: 566px; width: 813px" 
            BorderStyle="Solid">
