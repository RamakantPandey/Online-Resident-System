...
public partial class Belgumadmin : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into belgroom(subcity,min,max,type,address)values(@a,@b,@c,@d,@e)", con);
        con.Open();
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\Res.mdf;Integrated Security=True;User Instance=True");
        SqlCommand cmd = new SqlCommand("insert into belgpg(subcity,min,max,type,address)values(@f,@g,@h,@i,@j)", con);
        con.Open();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\Res.mdf;Integrated Security=True;User Instance=True");
        SqlCommand cmd = new SqlCommand("insert into belghost(subcity,min,max,type,address)values(@k,@l,@m,@n,@o)", con);
        con.Open();
