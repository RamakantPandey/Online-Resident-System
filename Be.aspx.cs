...
public partial class Be : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["be"] == "1")
        {
            SqlCommand cmd = new SqlCommand("select *from belgroom where subcity=@a and min=@b and max=@c and type=@d", con);
        ...
        else if (Session["be"] == "2")
        {
            SqlCommand cmd1 = new SqlCommand("select *from belgpg where subcity=@a and min=@b and max=@c and type=@d", con);
        ...
        else if (Session["be"] == "3")
        {
            SqlCommand cmd2 = new SqlCommand("select *from belghost where subcity=@a and min=@b and max=@c and type=@d", con);
